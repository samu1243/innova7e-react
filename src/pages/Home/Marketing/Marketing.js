    ...
    <div className='w-full marketing md:h-screen'>
        ...
        <div className='mx-auto flex flex-col justify-center w-full h-full'>
            <div className='grid md:grid-cols-2 w-full h-full'>
                ...
                <ImageContainer image={marketing} title={'Video Marketing'} color='white' descriptionOne={'Comerciales para'} descriptionTwo={'tus productos'} id='item-2'/>
                <ImageContainer image={branding} title={'Branding'} color='white' descriptionOne={'Haz valer tu marca'} descriptionTwo={'con nosotros'} id='item-3'/>
                <ImageContainer image={capacitacion} title={'Capacitación'} color='black' descriptionOne={'Aprende con'} descriptionTwo={'nosotros'} id='item-4'/>
            </div>
        </div>
    </div>
  )
